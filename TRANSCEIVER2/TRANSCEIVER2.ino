...
void loop() {
  // Display and print the received message periodically
  long now2 = millis();
  ...
  // Yield control to allow background tasks
  delay(1);
}
...
void onReceive(int packetSize) {
  ...
  // Set the flag to indicate a message has been received
  receivedFlag = true;
}
...
void perbaruiScreen() {
  ...
  // Line 2
  display.setFont(ArialMT_Plain_10);
  display.drawString(0, 15, "Receive Data : " + String(receivedMessage));
  display.setTextAlignment(TEXT_ALIGN_LEFT);
  // Line 3
  display.setFont(ArialMT_Plain_10);
...
void detail1() {
  // Line 4
  display.setFont(ArialMT_Plain_10);
  display.drawString(0, 35, "Data SDM: " + String(SDM));
  display.setTextAlignment(TEXT_ALIGN_LEFT);
  // Line 5
  display.setFont(ArialMT_Plain_10);
  display.drawString(0, 45, "Data LINIA: " + String(LINIA));
  display.setTextAlignment(TEXT_ALIGN_LEFT);
  // Line 6
  display.setFont(ArialMT_Plain_10);
  display.drawString(0, 55, "Data LINIB: " + String(LINIB));
  display.setTextAlignment(TEXT_ALIGN_LEFT);
  display.display();
}
...
void detail2() {
  // Line 4
  display.setFont(ArialMT_Plain_10);
  display.drawString(0, 35, "Data PUSYANTEK: " + String(PUSYANTEK));
  display.setTextAlignment(TEXT_ALIGN_LEFT);
  // Line 5
  display.setFont(ArialMT_Plain_10);
  display.drawString(0, 45, "Data MAKO: " + String(MAKO));
  display.setTextAlignment(TEXT_ALIGN_LEFT);
  // Line 6
  display.setFont(ArialMT_Plain_10);
  display.drawString(0, 55, "Data LOGAM: " + String(LOGAM));
  display.setTextAlignment(TEXT_ALIGN_LEFT);
  display.display();
}
...
void detail3() {
  // Line 4
  display.setFont(ArialMT_Plain_10);
  display.drawString(0, 35, "Data TASGANU: " + String(TASGANU));
  display.setTextAlignment(TEXT_ALIGN_LEFT);
  display.display();
}
void simpanSDMData() {
